...
var ledge = this.platforms.create(350,260, 'ground');
ledge.body.immovable = true;
var ledge = this.platforms.create(30,420, 'ground');
ledge.body.immovable = true;
var ledge = this.platforms.create(30,100, 'ground');
ledge.body.immovable = true;
...
for (var i = 0; i < 12; i++) {
    ...
    //This just gives each star a slightly random boucne value
